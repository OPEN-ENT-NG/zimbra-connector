    ...
    function($location, $scope, $timeout, $compile, $sanitize, model, route) {
        ...
        $scope.postAttachments = async () => {
            ...
            if (!mail.id) {
                ...
                await mail.postAttachment($scope, null);
            } else {
                await mail.postAttachment($scope, null);
            }
        };
        ...
        $scope.deleteAttachment = function(event, attachment, mail) {
            const response = mail.deleteAttachment($scope, attachment);
        ...
        $scope.uploadAttachment = async (attachment) => {
            ...
            newAttachment.filename = attachment.metadata.filename;
            newAttachment.size = attachment.metadata.size;
            newAttachment.id = attachment._id;
