...
public class IModelHelperTest {
    ...
    public void testSubClassIModel(TestContext ctx) {
        Reflections reflections = new Reflections("fr.openent.zimbra");
        ...
        invalidModel.forEach(modelClass -> {
            String message = String.format("[Zimbra@%s::testSubClassIModel]: The class %s must have public constructor with JsonObject parameter declared",
